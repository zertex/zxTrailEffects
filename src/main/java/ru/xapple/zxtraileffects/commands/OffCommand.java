...
@CommandDescription("Hide trails")
@CommandPermissions("zxtraileffects.off")
...
public class OffCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 1 && args[0].equalsIgnoreCase("off")) {
            ...
            player.sendMessage(new Messaging.MessageFormatter().format("trails.off"));
        }
        else {
            player.sendMessage("Use: /trail off");
        }
        return true;
    }
}
